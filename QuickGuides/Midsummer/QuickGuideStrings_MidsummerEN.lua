...
QG_MIDSUMMER_FH[QG_MIDSUMMER_FH_INDEX.IN_CELEBRATION_OF_MIDSUMMER_END].DISPLAY = function() return TurnInTo("In Celebration of Midsummer", "Captain Khâtaphos"); end;
