...
QG_ILAA[QG_ILAA_INDEX.A_BIT_OF_WHITE_PICKUP].DISPLAY = "In Thorin's Hall Inn, take 'A Bit of White' from Ale Association Tavern Keep";
QG_ILAA[QG_ILAA_INDEX.A_CONVOLUTED_WINE_PICKUP].DISPLAY = "Take 'A Convoluted Wine'";
QG_ILAA[QG_ILAA_INDEX.A_DARK_PRANK_PICKUP].DISPLAY = "Take 'A Dark Prank'";
QG_ILAA[QG_ILAA_INDEX.A_DIFFERENT_REMINDER_OF_RIVENDELL_PICKUP].DISPLAY = "Take 'A Different Reminder of Rivendell'";
QG_ILAA[QG_ILAA_INDEX.A_DRINK_OF_THE_BEST_CHARACTER_PICKUP].DISPLAY = "Take 'A Drink of the Best Character'";
QG_ILAA[QG_ILAA_INDEX.ALL_BUT_THE_GOOD_CIDER_PICKUP].DISPLAY = "Take 'All But the Good Cider'";
QG_ILAA[QG_ILAA_INDEX.BOMBURS_BREATH_PICKUP].DISPLAY = "Take 'Bombur's Breath'";
QG_ILAA[QG_ILAA_INDEX.NEVER_FURTHER_FROM_HOME_PICKUP].DISPLAY = "Take 'Never Further From Home'";
QG_ILAA[QG_ILAA_INDEX.NOT_ATLIS_FAVOURITE_PICKUP].DISPLAY = "Take 'Not Atli's Favourite'";
QG_ILAA[QG_ILAA_INDEX.ONE_DRINK_TOO_FEW_PICKUP].DISPLAY = "Take 'One Drink Too Few'";
QG_ILAA[QG_ILAA_INDEX.QUITE_A_TICKLE_PICKUP].DISPLAY = "Take 'Quite a Tickle'";

QG_ILAA[QG_ILAA_INDEX.QUITE_A_TICKLE_DRINK].DISPLAY = "Collect 'Fake Thistlebelly Brew' from Rúnulf, mount up.";
QG_ILAA[QG_ILAA_INDEX.QUITE_A_TICKLE_END].DISPLAY = "Travel to Ost Haer in Harloeg, turn in 'Quite a Tickle' to Wald Mugwort.";

QG_ILAA[QG_ILAA_INDEX.NEVER_FURTHER_FROM_HOME_DRINK].DISPLAY = "Travel to Prancing Pony in Bree, collect 'Fake Limael's Vintage' from Barliman Butterbur";
QG_ILAA[QG_ILAA_INDEX.ONE_DRINK_TOO_FEW_DRINK].DISPLAY = "Collect 'Fake Forsaken Ale' from Barliman Butterbur";
QG_ILAA[QG_ILAA_INDEX.ONE_DRINK_TOO_FEW_END].DISPLAY = "Travel to Thrasi's Lodge, turn in 'One Drink Too Few' to Alrek";
QG_ILAA[QG_ILAA_INDEX.NEVER_FURTHER_FROM_HOME_END].DISPLAY = "Travel to Thornley's Work Site in Bree-land, turn in 'Never Further From Home' to Wesley Hopwood";

QG_ILAA[QG_ILAA_INDEX.ALL_BUT_THE_GOOD_CIDER_DRINK].DISPLAY = "Travel to The Forsaken Inn in Lone-lands, collect 'Fake Stars of Old Cider' from Anlaf the Forlorn";
QG_ILAA[QG_ILAA_INDEX.A_CONVOLUTED_WINE_DRINK].DISPLAY = "Travel to 'The Bird and Baby Inn' in Michel Delving, collect 'Fake Brandy Wine' from Carlo Blagrove";
QG_ILAA[QG_ILAA_INDEX.A_BIT_OF_WHITE_DRINK].DISPLAY = "Travel to 'The Ivy Bush Inn' in Hobbiton, collect 'Fake Blagrove's Brown' from Hereward Loamsdown";
QG_ILAA[QG_ILAA_INDEX.BOMBURS_BREATH_DRINK].DISPLAY = "Travel to 'The Green Dragon' in Bywater, collect 'Fake Bombur's Beard Lager' from Barmy Rootknot";
QG_ILAA[QG_ILAA_INDEX.NOT_ATLIS_FAVOURITE_DRINK].DISPLAY = "Collect 'Fake Beakbreaker Ale' from Barmy Rootknot";
QG_ILAA[QG_ILAA_INDEX.A_DARK_PRANK_DRINK].DISPLAY = "Travel to 'The Floating Log Inn' in Frogmorton, collect 'Fake Moor-boar Beer' from Ponto Hopsbloom";

QG_ILAA[QG_ILAA_INDEX.BOMBURS_BREATH_END].DISPLAY = "Travel to Othrikar in North Downs, turn in 'Bombur's Breath' to Múli";
QG_ILAA[QG_ILAA_INDEX.A_BIT_OF_WHITE_END].DISPLAY = "Travel to Oatbarton in Evendim, turn in 'A Bit of White' to Harigar Mudbottom";
QG_ILAA[QG_ILAA_INDEX.ALL_BUT_THE_GOOD_CIDER_END].DISPLAY = "Travel to Brockenborings in The Shire, turn in 'All But the Good Cider' to Foxglove Grubb";
QG_ILAA[QG_ILAA_INDEX.A_DRINK_OF_THE_BEST_CHARACTER_DRINK].DISPLAY = "In 'The Plough and Stars', collect 'Fake Swill' from Halson Tubwort";
QG_ILAA[QG_ILAA_INDEX.NOT_ATLIS_FAVOURITE_END].DISPLAY = "Travel to Hrimbarg in Misty Mountains, turn in 'Not Atli's Favourite' to Óli";
QG_ILAA[QG_ILAA_INDEX.A_DIFFERENT_REMINDER_OF_RIVENDELL_DRINK].DISPLAY = "Travel to 'The Last Homely House' in Rivendell, collect 'Fake Dorwinion White' from Sogadan";

QG_ILAA[QG_ILAA_INDEX.A_CONVOLUTED_WINE_END].DISPLAY = "Travel to Echad Candelleth in Trollshaws, turn in 'A Convoluted Wine' to Saerthuithel";
QG_ILAA[QG_ILAA_INDEX.A_DARK_PRANK_END].DISPLAY = "Travel to Zigilgund in Forochel, turn in 'A Dark Prank' to Lófi";
QG_ILAA[QG_ILAA_INDEX.A_DRINK_OF_THE_BEST_CHARACTER_END].DISPLAY = "Travel to Aughaire in Angmar, turn in 'A Drink of the Best Character' to Nathalan";
QG_ILAA[QG_ILAA_INDEX.A_DIFFERENT_REMINDER_OF_RIVENDELL_END].DISPLAY = "Travel to Refuge of Edhelion in Ered Luin, turn in 'A Different Reminder of Rivendell' to Lendasil";
